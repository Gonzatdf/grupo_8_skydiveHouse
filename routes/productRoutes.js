...
router.post ("/create", upload.single("image"),createProductValidation, productController.create);

// Formulario de edición de productos
router.get ("/edit/:id", productController.editView);

//Acción de edición, a donde se envía el formulario 
router.put("/edit/:id", upload.single("image"),updateProductValidation,productController.updateProduct);
